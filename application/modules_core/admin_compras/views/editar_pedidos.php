            ...
            <form class="form-horizontal" method="post"	enctype="multipart/form-data" action="<?php echo $form_action;?>">
                ...
                <fieldset>
                            ...
                            <select name="idUsuariosComprador">
                                <?php foreach($usuarios as $usuario):?>
                                    <?php if($usuario['idUsuarios'] == $compras['idUsuariosComprador']):?>
                                        <option value="<?php echo $usuario['idUsuarios'];?>" selected="selected" disabled="disabled">
                                            <?php echo $usuario['email']. " - ". $usuario['nombre'] . " " .$usuario['apellido'];?>
                                        </option>
                                    <?php else:?>
                                        <option value="<?php echo $usuario['idUsuarios'];?>" disabled="disabled">
                                            <?php echo $usuario['email']. " - ". $usuario['nombre'] . " " .$usuario['apellido'];?>
                                        </option>
                                    <?php endif;?>
                                <?php endforeach;?>
                    ...
                    <div class="control-group formSep">
                        ...
                        <div class="controls">
                            <input type="text" id="email" name="tituloPublicacion" class="input-xlarge"
                                value="<?php if(isset($compras['tituloPublicacion'])) echo $compras['tituloPublicacion'];?>" readonly="readonly" />
                            <input type="hidden" name="idTrabajos" value="<?php if(isset($compras['idTrabajos'])) echo $compras['idTrabajos'];?>" />
                        </div>
                    </div>
                    ...
                    <div class="control-group formSep">
                        ...
                        <div class="controls">
                            <input  type="text" id="monto_venta_total" class="input-xlarge" name="monto_venta_total"
